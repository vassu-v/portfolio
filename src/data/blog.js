...
export const POSTS = [
  {
    ...
    subtitle: 'Three years of shipping real things from Kolkata, and what nobody tells you about starting before you\'re supposed to.',
    category: 'Reflection',
    date: '21 Jun 2026',
    isoDate: '2026-06-21',
    readTime: '5 min read',
    ...
    externalUrl: null,
    platform: null,
    keywords: ['17 year old developer India', 'student builder Kolkata', 'young developer India', 'building things at 17', 'India Innovates', 'Buy4Chai', 'SarkarSathi'],
    content: [
      ...
      { type: 'divider' },
      { type: 'paragraph', text: 'The clearest thing three years of building has taught me isn\'t technical. It\'s that shipping something (actually deploying it, having real users, getting 33 comments from people who have the exact same problem) teaches you things no tutorial reaches. Tutorials teach you how to code. Real projects teach you what to build and why it matters. Those are different educations.' },
      ...
      { type: 'divider' },
      { type: 'paragraph', text: 'I\'m 17. I have no idea what the next five years look like except that I\'m going to keep shipping things and seeing what sticks. Some of it will fail, quietly or loudly. Some of it already has.' },
  ...
  },
  {
    ...
    subtitle: 'How a Reddit thread confirmed the problem was real. Everyone was just coping.',
    category: 'Building',
    date: 'May 2026',
    isoDate: '2026-05-01',
    readTime: '4 min read',
    hero: '/blog/building-buy4chai/hero.jpeg',
    featured: true,
    personal: 'best',
    externalUrl: null,
    platform: null,
    ...
    content: [
      ...
      { type: 'divider' },
      { type: 'paragraph', text: 'So I built Buy4Chai. A self-hosted supporter page with Razorpay and UPI out of the box. If you have any payment link, manual or otherwise, you can integrate it. The setup video and AI prompts walk you through adding your own gateway without touching much code. Fork it, edit one config file, deploy to Vercel in ten minutes. Zero platform fees. Money goes directly to you.', link: { word: 'Buy4Chai', href: '/project/buy4chai' } },
  ...
  },
  {
    ...
    isoDate: '2026-05-15',
    readTime: '3 min read',
    hero: '/blog/markets-dont-get-disrupted/hero.jpeg',
    featured: true,
    personal: null,
    externalUrl: null,
    platform: null,
  ...
  },
  {
    ...
    isoDate: '2026-04-01',
    readTime: '3 min read',
    hero: '/blog/apple-ai-decade/hero.jpeg',
    featured: false,
    personal: null,
  ...
  },
  {
    ...
    isoDate: '2026-04-15',
    readTime: '4 min read',
    hero: '/blog/both-groups-are-losing/hero.jpeg',
    featured: false,
    personal: 'learned',
  ...
  },
  {
    ...
    isoDate: '2026-02-01',
    readTime: '5 min read',
    hero: '/blog/hardware-failure/hero.png',
    featured: false,
    personal: null,
