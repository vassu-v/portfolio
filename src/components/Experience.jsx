...
// ── Progress dots (subscribes to motion value, avoids hook-in-loop) ──────────
...
function Panel({ exp }) {
  ...
  return (
    <div style={{
      ...
      {/* Ghost number — huge, bottom-right */}
      ...
      <div style={{ maxWidth: '620px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          letterSpacing: '0.2em', color: 'var(--text3)', marginBottom: '32px',
        }}>
        ...
        <div style={{
          ...
          alignItems: 'baseline', gap: '20px', marginBottom: '5px', flexWrap: 'wrap',
        }}>
          <span style={{ fontSize: '0.97rem', fontWeight: 600, color: 'var(--text)' }}>
            {primaryRole}
          </span>
          <span style={{
            fontFamily: 'JetBrains Mono, monospace', fontSize: '0.56rem',
            color: live ? 'var(--cu)' : 'var(--text3)', letterSpacing: '0.05em',
            whiteSpace: 'nowrap',
          }}>
            {period}
          </span>
        ...
        <p style={{
          ...
          lineHeight: 1.88, marginBottom: '20px', maxWidth: '520px',
        }}>
          {desc}
        </p>

        {/* Additional roles (4MQ only) */}
        {extra && (
          <div style={{ display: 'flex', gap: '6px', marginBottom: '16px', flexWrap: 'wrap' }}>
            {extra.map(r => (
              <div key={r.title} style={{
                ...
                <div style={{
                  fontFamily: 'JetBrains Mono, monospace', fontSize: '0.52rem',
                  letterSpacing: '0.07em', color: 'var(--text2)', marginBottom: '2px',
                }}>
                  {r.title}
                </div>
                <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <motion.div style={{
              ...
              background: 'var(--cu)', width: barWidth,
            }} />
          </div>
